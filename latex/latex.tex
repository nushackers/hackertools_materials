...
\section{Adding Images, Citations and More}
\subsection{}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \textbf{Telegram}: \url{https://t.me/nushackers} (@nushackers)
    \item \textbf{Hackerschool}: Generative AI \& Prompt Engineering (\emph{tomorrow!})
  \end{itemize}
\end{frame}
