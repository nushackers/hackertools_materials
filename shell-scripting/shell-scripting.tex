...
\author{Jing Yen UWU}
\date{7 February 2023 \\ Slides at \url{https://hckr.cc/ht-shell-slides} \\ (Materials developed by Julius)}
...
\begin{frame}{About Me}
  Hi! I'm Jing Yen. My GitHub is \url{https://github.com/JingYenLoh}
...
\begin{frame}
  ...
  \begin{itemize}
    \item \textbf{Feedback form}: \url{https://hckr.cc/ht-shell-feedback}
    \item \textbf{Upcoming Hacker Tools}:

          Data Wrangling, \date{14th February 2023}, 6.30pm, Same Location! 
          \url{https://hckr.cc/ht-data-signups}
    \item \textbf{Happening this Thursday!}:

          Applcations of OpenCV: \url{https://hckr.cc/hs2223-w5}

    \item \textbf{Upcoming Friday Hacks}:

          Hack&Roll 23: More Hacks: \url{https://hckr.cc/links}
  \end{itemize}
\end{frame}
